...
#line 60 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\ant_stack_handler_types.h"
...
#line 80 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.h"
...
#line 42 "..\\..\\..\\main.c"
#line 43 "..\\..\\..\\main.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_advdata_parser.h"
...
#line 5 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_advdata_parser.h"
...
#line 51 "..\\..\\..\\main.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\ble\\ble_services\\ble_bas_c\\ble_bas_c.h"
...
#line 29 "..\\..\\..\\..\\..\\..\\components\\ble\\ble_services\\ble_bas_c\\ble_bas_c.h"
#line 30 "..\\..\\..\\..\\..\\..\\components\\ble\\ble_services\\ble_bas_c\\ble_bas_c.h"
...
#line 33 "..\\..\\..\\..\\..\\..\\components\\ble\\ble_services\\ble_dis\\ble_dis.h"
#line 34 "..\\..\\..\\..\\..\\..\\components\\ble\\ble_services\\ble_dis\\ble_dis.h"
...
#line 27 "..\\..\\..\\..\\..\\..\\components\\libraries\\sensorsim\\sensorsim.h"
#line 28 "..\\..\\..\\..\\..\\..\\components\\libraries\\sensorsim\\sensorsim.h"
...
#line 74 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\hal\\nrf_delay.h"
...
static sensorsim_cfg_t                   m_peripheral_battery_sim_cfg;                          
static sensorsim_state_t                 m_peripheral_battery_sim_state;                        
static sensorsim_cfg_t                   m_peripheral_heart_rate_sim_cfg;                       
static sensorsim_state_t                 m_peripheral_heart_rate_sim_state;                     
static sensorsim_cfg_t                   m_peripheral_rr_interval_sim_cfg;                      
static sensorsim_state_t                 m_peripheral_rr_interval_sim_state;                    
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            err_code = sd_ble_gatts_sys_attr_set(m_peripheral_conn_handle, 0, 0, (1 << 0));
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);
            break;
...
static void ble_stack_init(void)
{
    ...
    do { static uint32_t BLE_EVT_BUFFER[(((((sizeof(ble_evt_t) + (23))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE; ERR_CODE = softdevice_handler_init((NRF_CLOCK_LFCLKSRC_XTAL_20_PPM), BLE_EVT_BUFFER, sizeof(BLE_EVT_BUFFER), 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0); } while (0);
...
static void device_manager_init(void)
{
    ...
    err_code = bsp_button_is_pressed(17,&(init_param.clear_persistent_data));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);
...
static void peripheral_timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((5)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (5), (4) + 1, APP_TIMER_BUF, 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0); } while (0);
