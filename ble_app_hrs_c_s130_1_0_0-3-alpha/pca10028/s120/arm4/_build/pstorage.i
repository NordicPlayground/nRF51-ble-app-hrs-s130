#line 1 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 14 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 15 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
#line 16 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 17 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 19 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_assert.h"
...
#line 20 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
#line 21 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\softdevice\\s130\\headers_s130_v1_0_0-3-alpha\\nrf_soc.h"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 57 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"




 
#line 68 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 88 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 120 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 137 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
#line 185 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
...
static uint32_t cmd_queue_dequeue(void)
{
    ...
    if ((m_cmd_queue.count > 0) && (m_cmd_queue.flash_access == 0))
    {
        retval = cmd_process();
        if (retval != ((0x0) + 0))
        {
...
#line 412 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
    {
        ...
        switch (sys_evt)
        {
            ...
            case NRF_EVT_FLASH_OPERATION_ERROR:
                ...
                if (++p_cmd->n_tries == 3)
                {
                    ...
                    app_notify(((0x0) + 13), &m_cmd_queue.cmd[m_cmd_queue.rp]);
                }
                else
                {
                    
                    retval = cmd_process();
                    if (retval != ((0x0) + 0) && retval != ((0x0) + 17))
                    {
                                   ...
                                   uint32_t              tail_word_size)
{
    ...
    switch (m_swap_state)
    {
        case STATE_DATA_TO_SWAP_WRITE:
            ...
            retval = sd_flash_write((uint32_t *)(((pstorage_flash_page_end() - 1) * pstorage_flash_page_size())),
        ...
        case STATE_HEAD_RESTORE:
            ...
            retval = sd_flash_write((uint32_t *)(page_number * pstorage_flash_page_size()),
                                    (uint32_t *)((pstorage_flash_page_end() - 1) * pstorage_flash_page_size()),
                                    head_word_size);
            if (retval == ((0x0) + 0))
            {
                if (tail_word_size == 0)
        ...
        case STATE_SWAP_ERASE:
            ...
            retval = sd_flash_page_erase(((pstorage_flash_page_end() - 1) * pstorage_flash_page_size()) / pstorage_flash_page_size());
            if (retval == ((0x0) + 0))
            {
                m_swap_state = STATE_COMPLETE;
            }
...
uint32_t pstorage_init(void)
{
    ...
    m_next_page_addr    = ((pstorage_flash_page_end() - 1 - 1) * pstorage_flash_page_size());
    m_round_val         = 0;
...
#line 867 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\pstorage\\pstorage.c"
                           ...
                           pstorage_handle_t       * p_block_id)
{
    ...
    if (((p_module_param->block_size) > pstorage_flash_page_size()) || ((p_module_param->block_size) < 0x0010)) { return ((0x0) + 7); };    
    if (((p_module_param->block_count) == 0) || ((m_next_page_addr + ((p_module_param->block_count) *(p_module_param->block_size)) > ((pstorage_flash_page_end() - 1) * pstorage_flash_page_size()))) || ((((p_module_param->block_count) * (p_module_param->block_size)) > pstorage_flash_page_size()) && (pstorage_flash_page_size() % (p_module_param->block_size)))) { return ((0x0) + 7); };
