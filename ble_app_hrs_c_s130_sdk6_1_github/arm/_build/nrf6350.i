...
static uint8_t empty_str[18] = {0x40, ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '}; 


static _Bool nrf6350_lcd_set_instruction(uint8_t instr)
{
    nrf_delay_us(10000);
    data_buffer[0] = 0x00;
    data_buffer[1] = instr;
    return twi_master_transfer(0x3E << 1, data_buffer, 2, ((_Bool)1));
}
...
_Bool nrf6350_lcd_clear(void)
{
    nrf_delay_us(10000);
    data_buffer[0] = 0x00;
    data_buffer[1] = (uint8_t)(0x80 + 0x00);
    if (!twi_master_transfer(0x3E << 1, data_buffer, 2, ((_Bool)1)))
        return 0;
    if (!twi_master_transfer(0x3E << 1, empty_str, 18, ((_Bool)1)))
    {
        return 0;
    }
    data_buffer[1] = 0x80 + 0x40;
    if (!twi_master_transfer(0x3E << 1, data_buffer, 2, ((_Bool)1)))
        return 0;
    if (!twi_master_transfer(0x3E << 1, empty_str, 18, ((_Bool)1)))
        return 0;
...
_Bool nrf6350_lcd_init(void)
{
    ...
    if (!nrf6350_lcd_set_instruction(0x14))                 
        return 0;
    if (!nrf6350_lcd_set_contrast(0x08))       
        return 0;
...
_Bool nrf6350_lcd_write_string(const char *p_text, uint8_t size, uint8_t line, uint8_t pos)
{
    ...
    data_buffer[0] = 0x00;
    data_buffer[1] = 0x80 + (pos + line);
    if (!twi_master_transfer(0x3E << 1, data_buffer, 2, ((_Bool)1)))
        return 0;
    if (!twi_master_transfer(0x3E << 1, empty_str, 18 - pos, ((_Bool)1)))
        return 0;
    data_buffer[0] = 0x00;
    data_buffer[1] = 0x80 + (pos + line);
    if (!twi_master_transfer(0x3E << 1, data_buffer, 2, ((_Bool)1)))
    ...
    return twi_master_transfer(0x3E << 1, data_buffer, i+1, ((_Bool)1));
}
...
_Bool  nrf6350_js_get_value(int8_t * val)
{
    ...
    if (!twi_master_transfer(0x3F << 1 | (0x01), data_buffer, 1, ((_Bool)1)))
        return 0;
...
_Bool nrf6350_js_get_status(uint8_t * js_state)
{
    ...
    if (!twi_master_transfer(0x3F << 1 | (0x01), &js_data, 1, ((_Bool)1)))
    {
        return 0;
    }
    js_data   = ~js_data;
...
static _Bool nrf6350_lcd_write_without_recovery(uint8_t * data,
                                               uint8_t   data_length,
