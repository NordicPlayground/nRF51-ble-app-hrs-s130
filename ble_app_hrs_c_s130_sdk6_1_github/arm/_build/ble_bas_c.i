#line 1 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
...
#line 11 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 12 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
...
#line 13 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 14 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 15 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 16 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 17 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 18 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 19 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
...
#line 20 "..\\Source_s130\\ble\\ble_services\\ble_bas_c.c"
...
static void tx_buffer_process(void)
{
    if (m_tx_index != m_tx_insert_index)
    {
        ...
        if (err_code == ((0x0) + 0))
        {
            printf("[BAS_C]: SD Read/Write API returns Success..\r\n");
            m_tx_index++;
            m_tx_index &= 0x07;
        }
        else
        {
            printf("[BAS_C]: SD Read/Write API returns error. This message sending will be "
                "attempted again..\r\n");
        }
    }
}
...
{
    printf("[BAS_C]: Configuring CCCD. CCCD Handle = %d, Connection Handle = %d\r\n",
...
static void on_peer_central_write(ble_bas_c_t * p_ble_bas_c, const ble_evt_t * p_ble_evt)
{
    ...
    if( p_ble_bas_c->conn_handle != 0xFFFF )
    {
      
        p_write_params->flags    = 0x01;
        p_write_params->handle   = p_ble_bas_c->bl_handle;
        p_write_params->len      =  p_ble_evt->evt.gatts_evt.params.write.len;
...
void ble_bas_c_on_ble_evt(ble_bas_c_t * p_ble_bas_c, const ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_WRITE:
            on_peer_central_write(p_ble_bas_c, p_ble_evt);
