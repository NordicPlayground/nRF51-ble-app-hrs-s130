...
{
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_sys_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
...
static void pnp_id_encode(uint8_t * p_encoded_buffer, const ble_dis_pnp_id_t * p_pnp_id)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_pnp_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (len == 7); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
}
                         ...
                         ble_gatts_char_handles_t      * p_handles)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_char_value != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (char_len > 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 0, 0); } while (0); } } while (0);
